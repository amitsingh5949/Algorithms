...
class RegistrationPortal{
	...
	public static  final List<Student> registeredStudents = new ArrayList<>();

	public  static final RegistrationPortal  instance = new RegistrationPortal();;

	public static  synchronized RegistrationPortal getRegistrationPortal() {
		return instance;
	}

	public static synchronized void register(Student student) {
		if(student != null)
			registeredStudents.add(student);
	}

	public static synchronized List<Student> getRegisteredStudents(){
