package com.javaDwarf.graphs.leetcode.stronglyconnectedcomponent.tushar;
 ...
 */
public class ArticulationPointAmit<T> {
			...
			if(!visited.contains(adj)) {
				...
				if(visitedTime.get(vertex) <= lowTime.get(adj)) {
					...
					if(parent.get(vertex) != null){
						List<Integer> edgeArt = new ArrayList<>();
						edgeArt.add((int)vertex.getId());
						edgeArt.add((int)adj.getId());
						componentList.add(edgeArt);
	...
	public static void main(String args[]){
		...
		ArticulationPointAmit<Integer> ap = new ArticulationPointAmit<Integer>();
