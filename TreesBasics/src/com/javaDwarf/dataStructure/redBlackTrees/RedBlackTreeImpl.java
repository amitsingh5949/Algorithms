 ...
 * A red node must have two black nodes as children but vice versa may not be true
 * Number of black nodes from root to any leaf or null child(a place of a non leaf node where a child node can be inserted) must be same. 
 */
