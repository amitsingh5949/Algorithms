...
public class _51_N_Queens {
	 ...
	 * 
	 * Visualization : 4*4 board, with all 4 queens placed in column1. This is one possible combination move each queen in its row one at a time to
	 * generate 16C4 combinations. 
	 */
	 ...
	 * 
	 * time  : N! ( 1 queen can be placed n , second queen can be placed n-2 , ... 1 n(n-2)(n-4).2*1
	 * space  : N!+ N*N
	 */
